...
import eurovisionIcon from '~/routes/SingASong/SongSelectionV2/Components/SongCard/eurovision-icon.svg';
...
export const SongCardStatsIndicator = ({
  ...
  return stats?.plays ? (
    <div data-test="song-stat-indicator" className={`${indicatorBase} px-2`}>
      {playedToday ? (
        'Played today'
      ) : (
        <>
    ...
    <div className={`${indicatorBase} overflow-hidden [&_img]:h-7 [&_img]:w-7 [&_svg]:fill-white`}>
    ...
    <div className={`${indicatorBase} overflow-hidden [&_svg]:h-7 [&_svg]:w-7 [&_svg]:fill-white`}>
    ...
    <div className={`${indicatorBase} overflow-hidden [&_svg]:h-7 [&_svg]:w-7 [&_svg]:fill-[rgb(255,165,0)]`}>
