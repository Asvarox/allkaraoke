...
function HighScoresView({ onNextStep, highScores, singSetup, song }: Props) {
  ...
  return (
    <>
      {/* The local scores and the song's online board sit side by side once there is room for two
          columns; below that the online board follows the local one.
      ...
      <div className="flex flex-col items-start gap-3 lg:flex-row lg:gap-6 lg:pr-[25rem]">
        <div className="flex w-full flex-1 flex-col gap-3 sm:gap-2 lg:gap-4" data-test="highscores-container">
