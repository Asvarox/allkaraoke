...
import getNoteColor from '~/modules/game-engine/drawing/elements/utils/get-note-color';
import GoldNoteParticle from '~/modules/game-engine/drawing/particles/gold-note';
import SungTriangle from '~/modules/game-engine/drawing/particles/sung-triangle';
import { Shaders } from '~/modules/game-engine/drawing/shaders/shaders';
...
import drawPlayerFrequencyTrace from './elements/player-frequency-trace';
import drawPlayerNote from './elements/player-note';
import ParticleManager from './particle-manager';
import ExplodingNoteParticle from './particles/exploding-note';
import FadeoutNote from './particles/fadeout-note';
