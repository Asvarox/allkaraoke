import{a4 as Mt,a5 as Pt,a6 as zt,c as Oe,j as t,r as d,a7 as W,a8 as we,a9 as te,aa as I,ab as _e,a3 as g,ac as je,ad as At,ae as O,af as F,ag as Tt,ah as $,ai as Ge,aj as ne,ak as he,al as N,am as Ft,N as It,O as Nt,an as ke,ao as Ve,ap as He,aq as Rt,C as K,Z as G,ar as Ke,as as L,at as Lt,au as Bt,av as Dt,aw as Ue,ax as qe,ay as me,az as $t,aA as Ot,aB as D,aC as _t,aD as Ye,aE as We,aF as Gt,aG as Xe,aH as Vt,aI as Je,aJ as fe,aK as Ht,aL as Kt,aM as Q,aN as Ut,Y as qt,aO as Qe,aP as Ze,aQ as X,aR as Z,aS as et,aT as Yt,aU as tt,aV as nt,aW as st,aX as Wt,aY as Xt,aZ as at,G as rt,a_ as ot,a$ as Jt,X as it,W as ct,b0 as Qt,b1 as Zt,b2 as en,b3 as tn,b4 as lt,b5 as nn,b6 as ee,b7 as sn,b8 as dt,b9 as ut,ba as an,bb as pe,bc as rn,bd as on,be as cn,bf as ln,bg as dn,bh as un,bi as gn,bj as hn,bk as mn,bl as H,bm as fn}from"./index-SZkKekPG.js";import{u as pn,P as xn,a as bn,S as Sn,b as U,c as yn,f as vn,d as wn,e as jn}from"./Player-xTOfiemO.js";function kn(e){var n=Mt(e),s=n%1;return n===n?s?n-s:n:0}var En=Math.ceil,Cn=Math.max;function Ee(e,n,s){(s?Pt(e,n,s):n===void 0)?n=1:n=Cn(kn(n),0);var r=e==null?0:e.length;if(!r||n<1)return[];for(var a=0,i=0,o=Array(En(r/n));a<r;)o[i++]=zt(e,a,a+=n);return o}const Mn=Oe(t.jsx("path",{d:"M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM7.5 18c-.83 0-1.5-.67-1.5-1.5S6.67 15 7.5 15s1.5.67 1.5 1.5S8.33 18 7.5 18zm0-9C6.67 9 6 8.33 6 7.5S6.67 6 7.5 6 9 6.67 9 7.5 8.33 9 7.5 9zm4.5 4.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm4.5 4.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm0-9c-.83 0-1.5-.67-1.5-1.5S15.67 6 16.5 6s1.5.67 1.5 1.5S17.33 9 16.5 9z"}),"Casino"),Pn=Oe(t.jsx("path",{d:"M16.59 7.58 10 14.17l-3.59-3.58L5 12l5 5 8-8zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"}),"CheckCircleOutline");function zn({setFilters:e,filters:n,keyboardControl:s,visible:r,setVisible:a}){const i=d.useRef(null),[o,c]=d.useState(!1),l=m=>{e(p=>({...p,search:m}))};W("down",()=>{var m;(m=i.current)==null||m.blur()},{enabled:o,enableOnTags:["INPUT"]});const h=m=>{m.stopPropagation(),m.preventDefault(),l(m.key)};W(we,m=>{h(m),a(!0)},{enabled:!n.search&&s});const f=d.useCallback(m=>{s&&l(m)},[s]);return te(I.remoteSongSearch,f),W(we,m=>{var p;h(m),(p=i.current)==null||p.focus()},{enabled:!o&&s},[n.search]),W("Backspace",m=>{var p;(p=i.current)==null||p.focus()},{enabled:!o&&s},[n.search]),d.useEffect(()=>{o||a(!!n.search)},[o,n.search,a]),!n.search&&!r?null:t.jsx(An,{"data-test":"song-list-search",children:t.jsx(Tn,{large:!0,children:t.jsx("form",{"data-test":"filters-search-form",onSubmit:m=>{var p;m.preventDefault(),(p=i.current)==null||p.blur()},children:t.jsx(_e,{onFocus:()=>c(!0),onBlur:()=>c(!1),onKeyDown:m=>{var p;m.key==="Backspace"&&((p=n.search)==null?void 0:p.length)===0&&a(!1)},focused:o,autoFocus:!0,label:"Search",value:n.search??"",onChange:l,ref:i,"data-test":"filters-search"})})})})}const An=g("div",{target:"e1elgrzq1"})({name:"t46wvs",styles:"background:rgba(0, 0, 0, 0.7);padding:2rem;font-size:3rem;box-sizing:border-box;display:flex;flex-direction:row;gap:2rem;position:fixed;z-index:200;top:4.5rem;left:30rem;right:30rem"}),Tn=g("div",{target:"e1elgrzq0"})("flex:",e=>e.large?1.5:1,";");function Fn({onRandom:e,setFilters:n,filters:s,keyboardControl:r}){const[a,i]=d.useState(!1),o=()=>{n(c=>({...c,search:""}))};return t.jsxs(t.Fragment,{children:[t.jsxs(In,{children:[t.jsx(je,{title:"Search",placement:"left",children:t.jsx(Ce,{onClick:()=>a?o():i(!0),"data-test":"search-song-button",children:t.jsx(At,{})})}),t.jsx(je,{title:"Pick random",placement:"left",children:t.jsx(Ce,{onClick:e,"data-test":"random-song-button",children:t.jsx(Mn,{})})})]}),t.jsx(zn,{setFilters:n,filters:s,visible:a,setVisible:i,keyboardControl:r})]})}const Ce=g(O,{target:"e12uvlok1"})("box-shadow:inset 0 0 2px 2px ",F.colors.text.active,";background:black;width:7.5rem;height:7.5rem;border-radius:50%;display:flex;align-items:center;justify-content:center;svg{width:4.5rem;height:4.5rem;}"),In=g("div",{target:"e12uvlok0"})({name:"1x0sh4s",styles:"pointer-events:none;position:fixed;display:flex;flex-direction:column;align-items:center;justify-content:center;bottom:2.5rem;right:2.5rem;z-index:100;gap:2rem"});function gt({videoId:e,...n}){return t.jsx(Bn,{src:`https://img.youtube.com/vi/${e}/default.jpg`,alt:`Thumbnail image for YouTube video ${e}`,...n})}function Nn({videoId:e,...n}){const s=Tt(e)??e,[r,a]=d.useState(!0);d.useLayoutEffect(()=>{a(o=>!o)},[e]);const[i]=$(Ge);return i==="low"?null:t.jsxs(Rn,{...n,children:[t.jsx(Me,{videoId:r?e:s,visible:r}),t.jsx(Me,{videoId:r?s:e,visible:!r}),t.jsx(Ln,{videoId:s})]})}const Rn=g("div",{target:"elot36a3"})({name:"k44s62",styles:"position:relative;overflow:hidden;background:black"}),Ln=g(gt,{target:"elot36a2"})({name:"6dhm9o",styles:"visibility:hidden"}),Me=g(gt,{target:"elot36a1"})("position:absolute;transition:opacity 300ms;opacity:",e=>e.visible?1:0,";"),Bn=g("img",{target:"elot36a0"})({name:"4uwt2b",styles:"width:100%;height:100%;object-fit:cover"});function Dn({active:e,closePlaylist:n,playlists:s,selectedPlaylist:r,setSelectedPlaylist:a}){const{register:i,focused:o,focusElement:c}=ne({enabled:e,additionalHelp:{vertical:void 0,"horizontal-vertical":null}});return he({left:()=>n("left"),right:()=>n("right")},e),d.useEffect(()=>{const l=new URLSearchParams(window.location.search).get("playlist");l&&c(`playlist-${l}`)},[]),d.useEffect(()=>{if(o){const l=s.find(u=>`playlist-${u.name}`===o);if(l){const u=new URL(window.location.href);u.searchParams.set("playlist",l.name),window.history.pushState(null,"",u.toString()),a(l.name)}}},[o,s]),t.jsx($n,{"data-test":"song-list-playlists",active:e,children:s.map(l=>t.jsx(On,{"data-selected":`playlist-${l.name}`===o,active:e,...i(`playlist-${l.name}`,()=>c(`playlist-${l.name}`),void 0,l.name===r),...e?{}:{selected:`playlist-${l.name}`===o},children:l.display??l.name},l.name))})}const $n=g("div",{target:"eemp7f41"})("background:rgba(0, 0, 0, ",e=>e.active?.75:.5,");width:100vh;transform-origin:top right;transform:rotate(-90deg);position:absolute;z-index:200;left:-100vh;top:0;font-size:3.6rem;box-sizing:border-box;display:flex;flex-direction:row-reverse;gap:0;h2{",N,";margin:0;}"),On=g(O,{target:"eemp7f40"})("font-size:2.75rem;justify-self:stretch;flex-grow:1;",e=>!e.focused&&e.active&&"background-color: transparent;",";padding:1.5rem;",e=>e.selected?Ft:!e.active&&"opacity: .75;",";");var xe={},_n=Nt;Object.defineProperty(xe,"__esModule",{value:!0});var ht=xe.default=void 0,Gn=_n(It()),oe=t,Vn=(0,Gn.default)([(0,oe.jsx)("path",{fillRule:"evenodd",d:"M16.67 13.13C18.04 14.06 19 15.32 19 17v3h4v-3c0-2.18-3.57-3.47-6.33-3.87z"},"0"),(0,oe.jsx)("circle",{cx:"9",cy:"8",r:"4",fillRule:"evenodd"},"1"),(0,oe.jsx)("path",{fillRule:"evenodd",d:"M15 12c2.21 0 4-1.79 4-4s-1.79-4-4-4c-.47 0-.91.1-1.33.24C14.5 5.27 15 6.58 15 8s-.5 2.73-1.33 3.76c.42.14.86.24 1.33.24zm-6 1c-2.67 0-8 1.34-8 4v3h16v-3c0-2.66-5.33-4-8-4z"},"2")],"PeopleAlt");ht=xe.default=Vn;const Hn=JSON.parse(`{
  "af": [
    "Persian Dari",
    "Pashto"
  ],
